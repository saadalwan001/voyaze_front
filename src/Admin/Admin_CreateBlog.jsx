        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2 flex-wrap">
              <button type="button" onClick={() => execCommand("bold")} className="px-2 py-1 border rounded">B</button>
              <button type="button" onClick={() => execCommand("italic")} className="px-2 py-1 border rounded">I</button>
              ...
              <button type="button" onClick={() => insertEmoji("😊")} className="px-2 py-1 border rounded">😊</button>
              <button type="button" onClick={() => insertEmoji("👍")} className="px-2 py-1 border rounded">👍</button>
              <button type="button" onClick={() => insertEmoji("🌍")} className="px-2 py-1 border rounded">🌍</button>
            </div>
            <div
