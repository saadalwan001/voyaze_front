  ...
  return (
    <section className="py-16 px-4 md:px-12 bg-gray-50 text-center max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <p className="max-w-3xl mx-auto text-gray-600 mb-12">
        Discover Sri Lanka's most breathtaking locations – from serene beaches
        and misty hill country to ancient cities and wildlife escapes. Perfect
        spots for every kind of traveler.
      </p>

      {/* Grid for 8 cards only */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 py-[25px]">
        {attractions.slice(0, 8).map((dest, index) => (
          <div
            key={dest.id}
      ...
      <button
        ...
        className="mt-8 bg-[#03567F] text-white font-medium text-md px-[20px] py-[15px] w-fit rounded hover:bg-[#024360] transition-all hover:cursor-pointer"
